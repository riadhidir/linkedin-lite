...
import {addCategorie, deleteCategorie,editCategorie,getAllCategories,getCategorieById} from '../controllers/Categoriecontroller.js'
...
categorieRouter.get('/:id',auth(['Admin']),getCategorieById);